 ...
 * Ashdod Campus
 */
public class Lion extends Carnivore implements IAnimalFactory {
	 ...
	 */
	private Point defaultpoint = new Point(20,0);
	
	public Point getdefaultpoint() {return this.defaultpoint ;}
	
	
	public Lion(int size, int horSpeed, int verSpeed, String col,ZooPanel pan ) {
		
		super("Lion", new Point(20,0), 0.8*size,  new Carnivore("Lion",  new Point(20,0) ), size, horSpeed, verSpeed, col , pan );
	...
	public Lion(String name, Point location ) {
		...
		super(name, (Point.checkBoundaries(location) ? location : new Point(20,0) ));
