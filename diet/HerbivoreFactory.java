...
public class HerbivoreFactory  extends AnimalFactory {
	...
	public Animal getAnimal(String animal, int size, int horSpeed, int verSpeed, String col,ZooPanel pan ) {
		...
		if(animal.equalsIgnoreCase("Giraffe")) { return new Giraffe( size, horSpeed, verSpeed, col, pan ); }
		
		else if (animal.equalsIgnoreCase("Elephant")) { return new Elephant( size, horSpeed, verSpeed, col, pan ); }
		
		else if (animal.equalsIgnoreCase("Turtle")) { return new Turtle( size, horSpeed, verSpeed, col, pan ); }
